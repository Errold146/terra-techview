...
export function StatusPremium() {
    return (
        <div className="w-full group-data-[collapsible=icon]:w-auto group-data-[collapsible=icon]:mx-auto">
            ...
            <div className="group-data-[collapsible=icon]:hidden flex flex-col gap-1.5 p-3 rounded-xl border border-azul-500/25 bg-azul-500/10">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                        <FiStar size={13} className="text-azul-400 shrink-0" />
                        <span className="text-[12px] font-bold text-azul-300 uppercase tracking-widest">Premium</span>
                    </div>
                    <span className="text-[10px] font-semibold text-azul-400/70 bg-azul-400/15 px-2 py-0.5 rounded-full">Active</span>
                </div>
